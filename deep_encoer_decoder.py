...
decoded_2 = Dense(64, activation='relu')
decoded = Dense(784, activation='sigmoid')(decoded_2)
# decoded_2 = Dense(64, activation='relu')(encoded_2)
# decoded = Dense(784, activation='sigmoid')(decoded_2)
decoded(encoded_2)
encoded_input = Input(shape=(32,))
shared_decoder = Model()

autoencoder = Model(input_img, decoded(encoded_2))
...
# autoencoder.save(r"c:\temp\keras.hdf5")
